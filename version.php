...
$plugin->version   = 2020021307;         // The current plugin version (Date: YYYYMMDDXX)
...
$plugin->release  = 'v3.0';         // Requires this Moodle version (see https://docs.moodle.org/dev/Releases)